  ...
  return (
    <div className="text-cuisine flex items-center justify-center leading-5 min-h-[calc(100vh-229px)]">
      <div className="text-center w-[430px] py-[120px]">
        ...
        <button className="cursor-pointer text-center bg-[#fc8019] mt-[25px] text-[15px] text-white px-5 h-10 font-semibold leading-10 w-auto inline-block ">GO HOME</button>
      </div>
    </div>
  );
};
